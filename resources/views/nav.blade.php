<nav class="navbar shadow navbar-expand-md justify-content-center">
    ...
    <!--- ------Body   parts        -------------->
       <section class="main  first text-center">
  <div class="container">
  <div class="row">
  ...
  <div class="card-body">
    ...
    <small>By<a href="#" class="/btn /btn-primary"> ABCD </a> <i class="fa fa-bookmark-o" aria-hidden="true"></i><hr style="border-top-color: #C0C0C0;"></small>
  </div>
</div>
<div class="card border-white" style="width: 16rem;">
  <div class="card-body">
    ...
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <small>By<a href="#"> ABCD </a><i class="fa fa-bookmark-o" aria-hidden="true"></i></small><hr style="border-top-color: #C0C0C0;">
  </div>
</div>
<div class="card border-white" style="width: 16rem;">
  <div class="card-body">
    ...
    <h6 class="card-subtitle mb-2 text-muted">Card subtitle</h6>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <small>By<a href="#"> ABCD</a><i class="fa fa-bookmark-o" aria-hidden="true"></i></small>
  </div>
</div>
</div>
  ...
  <div class="row no-gutters">
    ...
    <div class="col-md-8">
      <div class="card-body">
        ...
        <p class="card-text"><small>By <a href="#" class="/btn /btn-primary">ABCD</a>   <i class="fa fa-bookmark-o" aria-hidden="true"></i></small>
      </div>
    </div>
  </div>
</div>
...
<div class="card border-white">
  ...
  <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="#" class="btn btn-primary">Go somewhere</a><hr style="border-top-color: #C0C0C0;">
  </div>
</div>
<div class="card border-white" style="width: 16rem;">
  <div class="card-body">
    ...
    <a href="#" class="card-link">Another link</a><hr style="border-top-color: #C0C0C0;">
  </div>
</div>
<div class="card border-white" style="width: 16rem;">
  <div class="card-body">
